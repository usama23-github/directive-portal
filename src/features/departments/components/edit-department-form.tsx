...
export const EditDepartmentForm = ({
  ...
  const onSubmit = (values: z.infer<typeof updateDepartmentSchema>) => {
    ...
    mutate({ form: finalValues, param: { departmentId: initialValues.$id } });
  };
          ...
          <Button
            ...
            onClick={
              onCancel
                ...
                : () =>
                    router.push(
                      `/workspaces/${initialValues.workspaceId}/departments/${initialValues.$id}`
                    )
            }
          >
                    ...
                    <div className="flex flex-col gap-y-2">
                      <div className="flex items-center gap-x-5">
                        ...
                        <div className="flex flex-col">
                          <p className="text-sm">Department Icon</p>
      ...
      <Card className="w-full h-full border-none shadow-none">
        <CardContent className="p-7">
          <div className="flex flex-col">
            ...
            <p>
              Deleting a department is irreversible and will remove all
              associated data.
            </p>
